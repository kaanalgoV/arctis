...
const PATTERNS: PatternDef[] = [
  ...
  },
  {
    ...
    sampleSize: 6,
    status: 'tier1',
    description: 'Price approaches POC, shows rejection wick. Best signal quality with highest selectivity.',
    setup: '3-bar approach to POC + rejection bar. Volume >= 1.2x 20-bar avg. Min R:R 2.0 (raised in v7).',
    keyInsight: 'NQ: 66.7% WR. ES: 33.3% WR. Very few signals generated = high quality filter.',
